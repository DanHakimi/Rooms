...
DATABASES = {
    # local development settings for now
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': '/home/sdd/project/dev.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '))tc33--wyn3060krm%-^cu(a5n)(kib%0_)za!nn_x8-r4*-w'
