...
urlpatterns = patterns("",
    ...
    url(r"^api/v1/", include(patterns("",
        ...
        url(r"^reservations/room/(?P<pk>\d+)/accept/$", views.api_room_reservation_request_accept, name="api_v1_room_reservation_request_accept"),
        url(r"^reservations/room/(?P<pk>\d+)/reject/$", views.api_room_reservation_request_reject, name="api_v1_room_reservation_request_reject"),
